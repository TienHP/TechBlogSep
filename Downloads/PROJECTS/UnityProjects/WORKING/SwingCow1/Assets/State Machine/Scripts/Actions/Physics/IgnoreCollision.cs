...
namespace StateMachine.Action{
	...
	public class IgnoreCollision : StateAction {
		...
		[FieldInfo(canBeConstant=false,nullLabel="None",tooltip="Second GameObject to ignore collision with.")]
		public ObjectParameter target;
		[FieldInfo(tooltip="Ignore the collsion if true.")]
